    ...
    <script src="<?= public_resource('www/sedna/bower_components/retina.js/dist/retina.js'); ?>"></script>
    ...
    <script src="<?= public_resource('www/sedna/js/uiMorphingButton_fixed.js'); ?>"></script>
    <script src="<?= public_resource('www/sedna/js/scripts.js'); ?>"></script>
    <script>
			(function() {
    ...
    <script src="<?= public_resource('www/sedna/js/jquery.flexslider-min.js'); ?>"></script>
    <script src="<?= public_resource('www/sedna/bower_components/classie/classie.js'); ?>"></script>
