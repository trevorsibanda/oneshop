          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" class="footercopy">
                &copy; <?= $shop['name'] . ' ' . date('Y') ?><br/>
                <a href="<?= $email['footer_action_url'] ?>" class="unsubscribe"><font color="#ffffff"><?= $email['footer_action'] ?></font></a> 
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                      <a href="<?= $shop['contact']['facebook_page'] ?>">
                        <img src="//assets.oneshop.co.zw/files/icons/facebook.png" width="37" height="37" alt="Facebook" border="0" />
                      </a>
                    </td>
                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                      <a href="https://twitter.com/<?= $shop['contact']['twitter_handle'] ?>">
                        <img src="//assets.oneshop.co.zw/files/icons/twitter.png" width="37" height="37" alt="Twitter" border="0" />
                      </a>
                    </td>
                  </tr>
                </table>
