...
<section class="main clearfix">
	<h4>Browse <?=  $category['name'] ?> category</h4>
	<div class="row "  >
		<div class="browse-bar"  >
			<div class="col-md-3 col-sm-12" >
				<img src="<?= product_image( $category['image'] ) ?>" class="img-responsive" />
			</div>
			<div class="col-md-9 col-sm-12" > 
				<legend><?= $category['name'] ?> <small class="pull-right"><?= count($products) ?> products</small></legend>
				<div class="row"  >
					<div class="col-md-4 col-sm-6" style=" background-color: #337AB7; color: white; padding-bottom: 5px;" >
						<label>Sort by</label>
	...
	<div class="row" >
		...
		<div class="col-md-4 col-xs-12 col-sm-8">
			...
			<a href="<?= $next_page_url ?>" class="btn btn-block btn-lg btn-default" >Next page</a>
			<?php endif;
			      if( $page['page']-1 > 0 ): ?>
			 <a href="<?= $prev_page_url ?>" class="btn btn-block btn-lg btn-default" >Previous page</a>
			 <?php endif; ?>     	
		</div>	
	</div>
	<div class="clearfix" ></div>
...
<?php $this->load->sys_theme('view_category_page_js'); ?>