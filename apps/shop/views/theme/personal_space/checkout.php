                        ...
                        <div class="woocommerce">
                            ...
                            <div class="cross-sells">
                                ...
                                <ul class="products">
                                    ...
                                    <li class="product">
                                        <a href="<?= $url ?>">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image img-responsive" src="<?= random_product_image($product) ?>">
                                            <h3><?= $product['name'] ?></h3>
                                ...
                                <form method="POST" action="/cart/checkout" >
									...
									<div class="hidden" id="shipping_options" >
										<label>Shipping costs</label>
			                                ...
			                                <?php endif; ?>
			                                <small>Note that *applicable* shipping cost will be added to your order.</small><br/>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        ...
                                        <tr class="shipping" >
                                            ...
                                            <td ><span class="shipping_cost"><?= money( $shipping_cost) ?></span></td>
                                        </tr>
