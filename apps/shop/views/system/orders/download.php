...
<title>Download - <?= $shop['name'] ?></title>
<!--
                ...
                <div class="col-sm-12 col-xs-12 col-md-4 col-lg-7">
                    ...
                    <div class="os_message-content">
                        <div class="os_message">
                            ...
                            <br/>
                            <p>Hey <?= $shopper['fullname'] ?>, Thank you for choosing us. <strong>Please note that you will only be able to download this files for two weeks after your purchase. You completed the order on <?= $order['transaction']['time_paid'] ?> and you will be able to download files until <span style="color: red;"><?= $max_download_date ?></span> <br/>
                            </p>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-md-9 col-xs-12 col-sm-9" >
                                    ...
                                    <?php if( ! $download_period_expired && $product['type'] == 'virtual' ): ?>
                                    <a target="_blank" href="<?=  $product['download_url'] ?>" class="btn pull-right btn-info "><i class="fa fa-download" ></i> Download file</a>
                                    <?php endif; ?>
                                </div>    
                            </div>
                            <?php endforeach; ?>
                            ...
                            <div class="row " style=" ">
                                <div class="browse-bar">
                                    ...
                                    <?php elseif( isset($is_virtual_order) ): ?>
                                    <div class="col-md-4 col-sm-6">
